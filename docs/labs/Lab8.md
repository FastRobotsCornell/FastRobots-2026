...
Your robot must start at the designated line (<4m from the wall), drive fast forward, and upon reaching the sticky mat with a center located 1ft from the wall, perform a flip, and drive back in the direction from which it came. You will need to add mass to the front of your car to get it to flip.
